 ...
 * @author Sameera
 */
@Named(value = "reportCustomerRegister")
@SessionScoped
public class ReportCustomerRegister implements Serializable {
    ...
    public void loadCustomersList() {
        ...
        List<OrganizationTypeManager> list = uniDB.searchByQueryLimit("SELECT o FROM OrganizationTypeManager o WHERE o.generalOrganizationProfileId.id='" + main_gop + "' AND o.organizationTypeId.id='18' ", 500);
    ...
    public void loadCustomersListBySearch() {
        ...
        customersLists.clear();
        List<OrganizationTypeManager> list = uniDB.searchByQueryLimit("SELECT o FROM OrganizationTypeManager o WHERE o.generalOrganizationProfileId.id='" + main_gop + "' AND o.generalOrganizationProfileId1.id='" + customer_id + "' AND o.organizationTypeId.id='18' ", 500);
        for (OrganizationTypeManager o : list) {
            customersLists.add(new CustomersList(o.getGeneralOrganizationProfileId1().getId(), o.getCode(), o.getGeneralOrganizationProfileId1().getName(), o.getGeneralOrganizationProfileId1().getPhone(), o.getGeneralOrganizationProfileId1().getEmail()));
        }

 ...
 * @author Sameera
 */
@Named(value = "cusromerRegistrationCorporate")
@SessionScoped
public class CusromerRegistrationCorporate implements Serializable {
    ...
    public void getCustumCode() {
        code = comLib.ORGCodeGenerator(main_gop, 1);
    }
    ...
    //--------------------------------------------------------------------------
    public void SaveCusromerRegistrationCorporate() {
        boolean result = customerRegistration.SaveGOPCorporate(name, no, street, city, postal_code, phone_i, phone_ii, email, fax,main_gop);

 ...
 */
@Entity
@Table(name = "gup_property")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "GupProperty.findAll", query = "SELECT g FROM GupProperty g")
    , @NamedQuery(name = "GupProperty.findById", query = "SELECT g FROM GupProperty g WHERE g.id = :id")})
public class GupProperty implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof GupProperty)) {
            return false;
        }
        GupProperty other = (GupProperty) object;
    ...
    public String toString() {
        return "com.ejb.model.entity.GupProperty[ id=" + id + " ]";
    }
